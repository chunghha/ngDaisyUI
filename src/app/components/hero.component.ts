...
@Component({
  ...
  template: `
    <section class="hero relative min-h-[calc(100vh-7rem)] overflow-hidden border border-base-300 bg-base-100 text-contrast shadow-2xl">
      ...
      <div class="pointer-events-none absolute top-8 right-10 hidden h-32 w-32 rounded-full border border-primary/30 md:block"></div>
      <div class="pointer-events-none absolute bottom-10 left-8 hidden h-20 w-20 rounded-full bg-secondary/20 blur-sm md:block"></div>
      ...
      <div class="hero-content relative z-10 grid w-full max-w-7xl gap-12 px-6 py-14 text-left lg:grid-cols-[1.05fr_0.95fr] lg:px-12">
        <div class="max-w-3xl">
          ...
          <div class="flex flex-col gap-3 sm:flex-row sm:items-center">
            ...
            <div class="rounded-full border border-base-content/15 bg-base-100/70 px-4 py-2 backdrop-blur">
              <Counter />
            </div>
          </div>
          <dl class="mt-10 grid max-w-xl grid-cols-3 gap-3 text-center sm:text-left">
            <div class="border border-base-content/10 bg-base-100/65 p-4 shadow-sm backdrop-blur">
        ...
        <div class="relative mx-auto w-full max-w-lg lg:mt-8">
          <div class="pointer-events-none absolute -top-8 -right-8 h-40 w-40 rounded-full bg-primary/30 blur-3xl"></div>
          <div class="pointer-events-none absolute -bottom-8 -left-10 h-48 w-48 rounded-full bg-secondary/25 blur-3xl"></div>
          <div class="relative border border-base-content/10 bg-base-100/75 p-4 shadow-2xl backdrop-blur-xl">
            <div class="border border-base-content/10 bg-neutral p-5 text-contrast shadow-inner">
              ...
              <div class="grid gap-4">
                <article class="group border border-base-content/10 bg-base-100 p-5 shadow-xl transition-transform hover:-translate-y-1">
                  <div class="mb-5 flex items-start justify-between gap-4">
                    ...
                    <div class="grid h-14 w-20 place-items-center border border-base-content/10 bg-[linear-gradient(135deg,#faf4ed_0_48%,#d7827e_48%_55%,#286983_55%)] shadow-lg"></div>
                  </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                  <div class="border border-base-content/10 bg-base-100/80 p-4 shadow-lg">
